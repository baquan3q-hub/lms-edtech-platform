...
export default async function ParentAnnouncementDetail({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="max-w-4xl mx-auto pb-12 animate-in fade-in duration-500">
            ...
            <Link href="/parent" className="flex items-center text-sm font-medium text-slate-500 hover:text-indigo-600 transition-colors w-fit mb-6">
                <ArrowLeft className="w-4 h-4 mr-1" /> Quay lại Bảng điều khiển
            </Link>
